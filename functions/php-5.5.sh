...
src_url=http://www.php.net/distributions/php-5.5.17.tar.gz && Download_src
...
patch -d php-5.5.17 -p0 < fpm-race-condition.patch
cd php-5.5.17
make clean
