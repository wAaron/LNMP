...
sed -i "s@/home/www/public_html@$home_dir/public_html@" $tengine_install_dir/conf/nginx.conf
sed -i "s@/home/logs@$logs_dir@g" $tengine_install_dir/conf/nginx.conf
...
sed -i "s@/home/www@$home_dir@g" vhost.sh
sed -i "s@/home/logs@$logs_dir@g" vhost.sh
ldconfig
service nginx start
}