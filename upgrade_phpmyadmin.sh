...
[ ! -e "$home_dir/public_html/phpMyAdmin" ] && echo -e "\033[31mThe phpMyAdmin is not installed on your system!\033[0m " && exit 1
...
Upgrade_phpMyAdmin()
{
Old_phpMyAdmin_version=`grep Version $home_dir/public_html/phpMyAdmin/README | awk '{print $2}'`
...
if [ -e "phpMyAdmin-${phpMyAdmin_version}-all-languages.tar.gz" ];then
	...
	rm -rf $home_dir/public_html/phpMyAdmin
	/bin/mv phpMyAdmin-${phpMyAdmin_version}-all-languages $home_dir/public_html/phpMyAdmin
