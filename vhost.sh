...
do
	echo
	read -p "Please input domain(example: www.domain.com): " domain
...
if [ "$moredomainame_yn" == 'y' ]; then
        ...
        do
                echo
                read -p "Type domainname,example(blog.domain.com bbs.domain.com): " moredomain
...
if [ "$access_yn" == 'n' ]; then
        ...
        A_log="CustomLog \"/home/logs/${domain}_apache.log\" common"
        echo "You access log file=/home/logs/${domain}_apache.log"
fi
}
...
<VirtualHost *:80>
    ...
    ServerName $domain
    $Domain_alias
    ErrorLog "/home/logs/${domain}_error_apache.log"
    $A_log
<Directory "$vhostdir">
